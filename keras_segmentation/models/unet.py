...
def _unet(n_classes, encoder, l1_skip_conn=True, input_height=540,
          input_width=960, channels=6):
...
def vgg_unet(n_classes, input_height=416, input_width=608, encoder_level=3, channels=6):
